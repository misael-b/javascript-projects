...
let newDnaTwo = dnaTwo.replace('GCT', 'AGG')
console.log(newDnaTwo)

//2) Look for the gene "CAT" with ``indexOf()``. If found print, "CAT gene found", otherwise print, "CAT gene NOT found".
let CatinDna = dnaTwo.indexOf('CAT');
if (CatinDna > 0) {
...
console.log(`${dnaTwo.slice(4, 7).toLowerCase()}o ${dnaTwo.slice(dnaTwo.length - 11, dnaTwo.length - 8).toLowerCase()}`)